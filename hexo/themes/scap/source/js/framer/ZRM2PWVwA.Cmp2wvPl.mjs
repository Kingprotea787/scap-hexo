      ...
      (U = async (e, t) => {
        ...
        for (;;) {
          try {
            ...
            if (!Ze.includes(r.status) || ++n > H) return r;
          } catch (e) {
...
function nt(e) {
  return typeof e == `object` && !!e && !o(e) && at in e;
}
function rt(e, ...t) {
  if (!e) throw Error(`Assertion Error` + (t.length > 0 ? `: ` + t.join(` `) : ``));
}
...
var K,
  ...
  Nt = e(() => {
    (u(),
      ...
      st(),
      (q = {
        aPs0LyMFs: { isNullable: !0, type: f.String },
        createdAt: { isNullable: !0, type: f.Date },
        e44O8jjMd: { isNullable: !0, type: f.Date },
        id: { isNullable: !1, type: f.String },
        nextItemId: { isNullable: !0, type: f.String },
        OqqCWBVct: { isNullable: !0, type: f.ResponsiveImage },
        P3BOIXzYK: { isNullable: !0, type: f.String },
        previousItemId: { isNullable: !0, type: f.String },
        qXUNIF8kG: { isNullable: !0, type: f.ResponsiveImage },
        S4o7z4Psh: { isNullable: !0, type: f.String },
        tsWKM6lyk: { isNullable: !0, type: f.String },
        updatedAt: { isNullable: !0, type: f.Date },
        VGQRXHMFS: { isNullable: !0, type: f.RichText },
        wfPmAnXMd: { isNullable: !0, type: f.String },
        XVH_tgELr: { isNullable: !0, type: f.String },
        XwulivaM5: { isNullable: !0, type: f.String },
        YHo9k2VRN: { isNullable: !0, type: f.ResponsiveImage },
        YHsDzvkBN: { isNullable: !0, type: f.String },
        yphiaikeG: { isNullable: !0, type: f.ResponsiveImage },
        Z8v3oSKF6: { isNullable: !0, type: f.Link },
      }),
      (ct = [`id`]),
      (J = { type: 1 }),
      (lt = [`previousItemId`]),
      ...
      (Q = {
          ...
          default: new et({
            chunks: [
              new URL(
                ...
                `https://framerusercontent.com/modules/uBgfwbcwNLemHZ1MiG3b/XdIW6bNsr8sBOIZRpJ7J/ZRM2PWVwA.js`
              ).href.replace(`/modules/`, `/cms/`),
            ],
            id: `3a6c3620-9a36-4842-9042-1593e0154985default`,
            indexes: [
              new W({
                collation: J,
                collectionSchema: q,
        ...
        displayName: `Work`,
        id: `3a6c3620-9a36-4842-9042-1593e0154985`,
      }),
      (At = Q),
      d(Q, {
        XVH_tgELr: { preventLocalization: !0, title: `Slug`, type: f.String },
        YHsDzvkBN: { defaultValue: ``, title: `Category`, type: f.String },
        wfPmAnXMd: { defaultValue: ``, title: `Title`, type: f.String },
        aPs0LyMFs: { defaultValue: ``, displayTextArea: !1, title: `Inner Title`, type: f.String },
        Z8v3oSKF6: { title: `Site Link`, type: f.Link },
        P3BOIXzYK: { defaultValue: ``, title: `Roll No`, type: f.String },
        yphiaikeG: { title: `BG Image`, type: f.ResponsiveImage },
        YHo9k2VRN: { title: `Inner Image`, type: f.ResponsiveImage },
        OqqCWBVct: { title: `Image 1`, type: f.ResponsiveImage },
        qXUNIF8kG: { title: `Image 2`, type: f.ResponsiveImage },
        e44O8jjMd: { title: `Date`, type: f.Date },
        S4o7z4Psh: { defaultValue: ``, title: `Client`, type: f.String },
        tsWKM6lyk: { defaultValue: ``, title: `Duration`, type: f.String },
        XwulivaM5: { defaultValue: ``, title: `Location`, type: f.String },
        VGQRXHMFS: { defaultValue: ``, title: `Body Text`, type: f.RichText },
          ...
          let [n] = await Z.query(
            {
              ...
              select: [{ name: `XVH_tgELr`, type: `Identifier` }],
              where: {
          ...
          let [n] = await Z.query(
            {
              ...
              where: {
                left: { name: `XVH_tgELr`, type: `Identifier` },
                operator: `==`,
                right: { type: `LiteralValue`, value: e },
                type: `BinaryOperation`,
              },
        ...
        exports: {
          ...
          default: {
            ...
            annotations: {
              ...
              framerData: `true`,
              framerSlug: `XVH_tgELr`,
              framerRecordIdKey: `id`,
              framerCollectionId: `ZRM2PWVwA`,
...
export { Mt as a, Nt as i, $ as n, jt as r, At as t };
//# sourceMappingURL=ZRM2PWVwA.Cmp2wvPl.mjs.map
